...
console.log("Luas Persegi Dengan Sisi 8 Adalah:", luasPersegi(sisiPersegi));
console.log("Luas Persegi Panjang Dengan Panjang 9 dan Lebar 3 Adalah:", luasPersegiPanjang(panjangPersegiPanjang, lebarPersegiPanjang));
...
console.log("Luas Segitiga Dengan Alas 6 dan Tinggi 4 Adalah:", luasSegitiga(alasSegitiga, tinggiSegitiga));

console.log("");

console.log(">> Keliling Bangun Datar <<");
console.log("Keliling Persegi Dengan Sisi 8 Adalah:", kelilingPersegi(sisiPersegi));
console.log("Keliling Persegi Panjang Dengan Panjang 9 dan Lebar 3 Adalah:", kelilingPersegiPanjang(panjangPersegiPanjang, lebarPersegiPanjang));
...
console.log("Keliling Segitiga Dengan Alas 6 dan Tinggi 4 Adalah:", kelilingSegitiga(sisiSegitiga));